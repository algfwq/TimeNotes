...
public class MainActivity extends AppCompatActivity {
    ...
    // HTML <input type="file"> / Semi Upload — without this, Android WebView ignores file picks.
    ...
    private void setupWebView() {
        ...
        // Needed for <input type="file"> results and content URIs from the system picker.
        ...
        // HTML file inputs (素材导入 / 背景图 / Semi Upload) require WebChromeClient.
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                ...
                if (request.getUrl().getHost() != null &&
                    ...
                    // Large binding responses (OpenNote with assets, etc.)
                    if (path != null && path.startsWith("/__binding_payload__/")) {
                        return serveBindingPayload(path.substring("/__binding_payload__/".length()));
                    }
    ...
    /** Serve a one-shot large binding payload stored by WailsBridge. */
    private WebResourceResponse serveBindingPayload(String token) {
        try {
            ...
            byte[] data = bridge != null ? bridge.takeLargeBindingPayload(clean) : null;
            if (data == null) {
                return new WebResourceResponse(
                        "application/json",
                        "UTF-8",
                        ...
                        "Not Found",
                        new java.util.HashMap<>(),
                        new java.io.ByteArrayInputStream("{\"ok\":false,\"error\":\"payload expired\"}".getBytes())
                );
            }
            java.util.Map<String, String> headers = new java.util.HashMap<>();
            headers.put("Access-Control-Allow-Origin", "*");
            ...
            Log.e(TAG, "serveBindingPayload failed", e);
            return new WebResourceResponse(
                    "application/json",
                    "UTF-8",
                    500,
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == HTML_FILE_CHOOSER_REQUEST) {
            ...
            if (htmlFilePathCallback != null) {
                htmlFilePathCallback.onReceiveValue(results);
                htmlFilePathCallback = null;
            }
            return;
        }
